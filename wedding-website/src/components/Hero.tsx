  ...
  return (
    <div className="flex items-center sm:justify-start justify-center sm:pl-32 h-screen bg-cover bg-center bg-bg-mobile sm:bg-bg-bigscreen ">
      ...
      <div className="p-5 text-white z-[2] mt-[-10rem]">
        <h2 className=" text-8xl font-bold font-mark">Henriette og Sivert</h2>
        <p className="py-3 text-4xl font-display pt-8">17. juni 2023</p>
        <div className="pt-52 text-4xl font-display">
          <button className="px-8 py-3 border w-full" onClick={handleClick}>
            Påmelding
          </button>
        </div>
      </div>
